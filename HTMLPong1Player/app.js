...
window.onload = () => {
    console.log("Game loaded!"); // Game has loaded
...
function move() {
    ...
    for (let step = 0; step < amtSteps; step += 1) {
...
function draw() {
    ...
    if (showWinScreen) {
        if (player1Score >= winScore) {
            ...
            canvasContext.fillText("You Won!", (canvas.width / 2), ((canvas.height / 2) - 50))
        } else {
            canvasContext.fillStyle = 'white';
            canvasContext.font = "60px monospace";
            canvasContext.textAlign = "center";
            canvasContext.fillText("The Bot Won!", (canvas.width / 2), ((canvas.height / 2) - 50))
        }
    ...
    canvasContext.fillText("You", (canvas.width / 4), 130);
    canvasContext.fillText("Bot", ((canvas.width * 3) / 4), 130);
}
